...
class Point2D {
    ...
    squareDistanceToLine(p1, p2) {
        let lineLength2 = p1.squareDistanceToPoint(p2);
        let dist;
        if (lineLength2 === 0.0) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const CanvasTools_Filter_1 = __webpack_require__(18);
const Rect_1 = __webpack_require__(1);
const RegionsManager_1 = __webpack_require__(16);
const AreaSelector_1 = __webpack_require__(19);
const ToolbarIcon_1 = __webpack_require__(7);
const Toolbar_1 = __webpack_require__(15);
let panzoom = __webpack_require__(34);
exports.factor = 1;
exports.isAltKey = false;
class Editor {
    constructor(editorZone) {
        ...
        var area = document.querySelector('.CanvasToolsEditor');
        ...
        instance.on('zoom', function (e) {
            exports.factor = instance.getTransform().scale;
            var rects = document.querySelectorAll('.primaryTagRectStyle');
            rects.forEach((item) => { item.style['stroke-width'] = (2 / exports.factor); });
            var ploygons = document.querySelectorAll('.primaryTagPolygonStyle');
            ploygons.forEach((item) => { item.style['stroke-width'] = (2 / exports.factor); });
            var ploylines = document.querySelectorAll('.primaryTagPolylineStyle');
            ploylines.forEach((item) => { item.style['stroke-width'] = (2 / exports.factor); });
            var circles = document.querySelectorAll('.anchorStyle');
            circles.forEach((item) => { item.style['r'] = (5 / exports.factor); item.style['stroke-width'] = (2 / exports.factor); });
            var circles2 = document.querySelectorAll('.nextPointStyle');
            circles2.forEach((item) => { item.style['r'] = (5 / exports.factor); item.style['stroke-width'] = (2 / exports.factor); });
            var crosslines = document.querySelectorAll('.crossStyle');
            crosslines.forEach((item) => { item.style['stroke-width'] = (2 / exports.factor); });
            var circles3 = document.querySelectorAll('.dragPointStyle');
            circles3.forEach((item) => { item.style['r'] = (5 / exports.factor); item.style['stroke-width'] = (2 / exports.factor); });
            var circles3 = document.querySelectorAll('.pointStyle');
            circles3.forEach((item) => { item.style['r'] = (5 / exports.factor); item.style['stroke-width'] = (2 / exports.factor); });
            var ploylines2 = document.querySelectorAll('.dragRectStyle');
            ploylines2.forEach((item) => { item.style['stroke-width'] = String(20 / exports.factor); });
            var ploylines3 = document.querySelectorAll('.nextSegmentStyle');
            ploylines3.forEach((item) => { item.style['stroke-width'] = String(2 / exports.factor); });
        });
        instance.pause();
        ...
        window.addEventListener("keydown", (e) => {
            if (e.altKey) {
                if (!this.ispointdown) {
                    this.regionsManager.freezenoselect();
                    instance.resume();
                    exports.isAltKey = true;
                }
            }
            if (e.keyCode == 90) {
        ...
        window.addEventListener("keyup", (e) => {
            ...
            if (exports.isAltKey && this.isRMFrozen && !this.isoncapture) {
...
Editor.FullToolbarSet = [
    ...
    },
    {
        ...
        keycode: 'KeyY',
        actionCallback: (action, rm, sl) => {
            sl.setSelectionMode(AreaSelector_1.SelectionMode.POLYGON3D);
        },
        activate: false
    },
    {
...
(function (RegionDataType) {
    ...
    RegionDataType["Polygon3D"] = "polygon3D";
...
Object.defineProperty(exports, "__esModule", { value: true });
const Point2D_1 = __webpack_require__(0);
const ElementPart_1 = __webpack_require__(13);
...
Object.defineProperty(exports, "__esModule", { value: true });
const RegionComponent_1 = __webpack_require__(9);
...
class DragComponent extends RegionComponent_1.RegionComponent {
    ...
    onDragMove(dx, dy) {
        if (dx != 0 && dy != 0) {
            let p = new Point2D_1.Point2D(this.dragOrigin.x + dx / g.factor, this.dragOrigin.y + dy / g.factor);
            if (g.isAltKey) {
                p = new Point2D_1.Point2D(this.dragOrigin.x - dx / g.factor, this.dragOrigin.y - dy / g.factor);
            }
...
class AnchorsComponent extends RegionComponent_1.RegionComponent {
    ...
    createAnchor(paper, x, y, style, r = AnchorsComponent.DEFAULT_ANCHOR_RADIUS) {
        const a = paper.circle(x, y, r / g.factor);
...
const Rect_1 = __webpack_require__(1);
const ToolbarIcon_1 = __webpack_require__(7);
const ToolbarSelectIcon_1 = __webpack_require__(23);
const ToolbarSeparator_1 = __webpack_require__(24);
const ToolbarSwitchIcon_1 = __webpack_require__(25);
class Toolbar {
    constructor(svgHost) {
        this.iconSpace = 8;
...
const Rect_1 = __webpack_require__(1);
const IRegionCallbacks_1 = __webpack_require__(4);
const RectRegion_1 = __webpack_require__(17);
const PointRegion_1 = __webpack_require__(20);
const PolygonRegion_1 = __webpack_require__(48);
const PolygonRegion_2 = __webpack_require__(52);
const PolylineRegion_1 = __webpack_require__(56);
const RegionMenu_1 = __webpack_require__(60);
...
class RegionsManager {
    ...
    addRegion(id, regionData, tagsDescriptor) {
        ...
        else if (regionData.type === RegionData_1.RegionDataType.Polygon3D) {
    ...
    addPolygonRegion3D(id, regionData, tagsDescriptor) {
        this.menu.hide();
        let region = new PolygonRegion_2.PolygonRegion3D(this.paper, this.paperRect, regionData, id, tagsDescriptor, {
            onChange: this.onRegionChange.bind(this),
            onManipulationBegin: this.onManipulationBegin_local.bind(this),
            onManipulationEnd: this.onManipulationEnd_local.bind(this)
        }, this.tagsUpdateOptions);
...
const AnchorsElements_1 = __webpack_require__(26);
...
Object.defineProperty(exports, "__esModule", { value: true });
const Rect_1 = __webpack_require__(1);
const PointSelector_1 = __webpack_require__(27);
const PolylineSelector_1 = __webpack_require__(28);
const PolygonSelector_1 = __webpack_require__(29);
const PolygonSelector3D_1 = __webpack_require__(30);
const RectCopySelector_1 = __webpack_require__(31);
const RectSelector_1 = __webpack_require__(32);
var SelectionMode;
(function (SelectionMode) {
    ...
    SelectionMode[SelectionMode["POLYGON3D"] = 6] = "POLYGON3D";
...
class AreaSelector {
    ...
    setSelectionMode(selectionMode, options) {
        ...
        else if (selectionMode === SelectionMode.POLYGON3D) {
            this.selector = this.polygonSelector3D;
        }
        this.enable();
        if (this.isVisible) {
            this.show();
    ...
    buildUIElements() {
        ...
        this.polygonSelector3D = new PolygonSelector3D_1.PolygonSelector3D(this.parentNode, this.paper, this.boundRect, this.callbacks);
        this.selector = this.rectSelector;
        ...
        this.polygonSelector3D.disable();
        this.selector.hide();
        ...
        this.areaSelectorLayer.add(this.polygonSelector3D.node);
    }
}
...
const Point2D_1 = __webpack_require__(0);
const RegionData_1 = __webpack_require__(3);
const Tag_1 = __webpack_require__(21);
const TagsDescriptor_1 = __webpack_require__(61);
const CanvasTools_Editor_1 = __webpack_require__(2);
...
const Point2D_1 = __webpack_require__(0);
const IRegionCallbacks_1 = __webpack_require__(4);
const AnchorsComponent_1 = __webpack_require__(12);
...
const Point2D_1 = __webpack_require__(0);
const RegionData_1 = __webpack_require__(3);
const CrossElement_1 = __webpack_require__(5);
...
class PointSelector extends Selector_1.Selector {
    ...
    buildUIElements() {
        ...
        this.point = this.paper.circle(0, 0, this.pointRadius / g.factor);
    ...
    onPointerMove(e) {
        window.requestAnimationFrame(() => {
            ...
            const p = new Point2D_1.Point2D((e.clientX - rect[0].left) / g.factor, (e.clientY - rect[0].top) / g.factor);
            this.show();
...
class PolylineSelector extends Selector_1.Selector {
    ...
    buildUIElements() {
        ...
        this.crossA = new CrossElement_1.CrossElement(this.paper, this.boundRect);
        this.nextPoint = this.paper.circle(0, 0, this.pointRadius / g.factor);
    ...
    addPoint(x, y) {
        ...
        const point = this.paper.circle(x, y, this.pointRadius / g.factor);
    ...
    onKeyUp(e) {
        if (e.code === "Escape" && this.lastPoint != null) {
            this.submitPolyline();
        }
        if (this.isAltKey) {
            this.isAltKey = false;
...
class PolygonSelector extends Selector_1.Selector {
    ...
    resize(width, height) {
        ...
        this.scalepoints = [];
        this.points.forEach((p) => {
            this.scalepoints.push(new Point2D_1.Point2D(p.x * g.factor, p.y * g.factor));
        });
        let pointsStr = "";
        ...
        if (this.lastPoint != null) {
            this.scalelastPoint = new Point2D_1.Point2D(this.tmplastPoint.x * g.factor, this.tmplastPoint.y * g.factor);
        }
        let ps = this.pointsGroup.children();
    ...
    addPoint(x, y) {
        this.points.push(new Point2D_1.Point2D(x / g.factor, y / g.factor));
        this.scalepoints.push(new Point2D_1.Point2D(x, y));
        const point = this.paper.circle(x, y, this.pointRadius / g.factor);
        ...
        if (!this.isAltKey) {
            if (e.detail <= 1) {
                window.requestAnimationFrame(() => {
                    ...
                    this.addPoint(p.x, p.y);
                    this.lastPoint = p;
                    this.tmplastPoint = new Point2D_1.Point2D(this.crossA.x / g.factor, this.crossA.y / g.factor);
    ...
    submitPolyline() {
        if (typeof this.callbacks.onSelectionEnd === "function") {
            ...
            this.callbacks.onSelectionEnd(new RegionData_1.RegionData(box.x, box.y, box.width, box.height, this.scalepoints.map((p) => p.copy()), RegionData_1.RegionDataType.Polygon));
        }
        this.reset();
    }
    onKeyDown(e) {
...
const Selector_1 = __webpack_require__(6);
const g = __webpack_require__(2);
class PolygonSelector3D extends Selector_1.Selector {
    constructor(parent, paper, boundRect, callbacks) {
        super(paper, boundRect, callbacks);
        this.pointRadius = 3;
        this.isCapturing = false;
    ...
    resize(width, height) {
        ...
        this.scalepoints = [];
        this.points.forEach((p) => {
            this.scalepoints.push(new Point2D_1.Point2D(p.x, p.y));
        });
        let pointsStr = "";
        this.scalepoints.forEach((p) => {
            pointsStr += `${p.x},${p.y},`;
        ...
        if (this.lastPoint != null) {
            this.scalelastPoint = new Point2D_1.Point2D(this.tmplastPoint.x, this.tmplastPoint.y);
        }
        let ps = this.pointsGroup.children();
        for (var i = 0; i < ps.length; i++) {
            ps[i].attr({
        ...
        if (!this.isAltKey) {
            if (e.detail <= 1) {
                window.requestAnimationFrame(() => {
                    ...
                    this.addPoint(p.x, p.y);
                    this.lastPoint = p;
                    this.tmplastPoint = new Point2D_1.Point2D(this.crossA.x, this.crossA.y);
                    this.scalelastPoint = null;
    ...
    onPointerMove(e) {
        window.requestAnimationFrame(() => {
            if (this.points.length != 3) {
                ...
                const rect = this.parentNode.getClientRects();
                let p = new Point2D_1.Point2D(this.lastPoint.x, e.clientY - rect[0].top);
                this.show();
                this.moveCross(this.crossA, p);
                this.movePoint(this.nextPoint, p);
                if (this.lastPoint != null) {
                    if (this.scalelastPoint != null) {
                        p = new Point2D_1.Point2D(this.scalelastPoint.x, e.clientY - rect[0].top);
                        this.moveLine(this.nextLN, this.scalelastPoint, p);
                    }
                    else {
                        this.moveLine(this.nextLN, this.lastPoint, p);
    ...
    submitPolyline() {
        if (typeof this.callbacks.onSelectionEnd === "function") {
            const box = this.polygon.getBBox();
            this.callbacks.onSelectionEnd(new RegionData_1.RegionData(box.x, box.y, box.width, box.height, this.scalepoints.map((p) => p.copy()), RegionData_1.RegionDataType.Polygon3D));
        }
        this.reset();
    }
    disable() {
...
exports.PolygonSelector3D = PolygonSelector3D;
...
const RegionData_1 = __webpack_require__(3);
const CrossElement_1 = __webpack_require__(5);
const RectElement_1 = __webpack_require__(14);
const Selector_1 = __webpack_require__(6);
const g = __webpack_require__(2);
...
const RegionData_1 = __webpack_require__(3);
const CrossElement_1 = __webpack_require__(5);
const MaskElement_1 = __webpack_require__(33);
const RectElement_1 = __webpack_require__(14);
const Selector_1 = __webpack_require__(6);
const g = __webpack_require__(2);
...
class RectSelector extends Selector_1.Selector {
    ...
    onKeyUp(e) {
        ...
        this.isAltKey = false;
        if (!e.ctrlKey && this.isTwoPoints == false) {
            this.isTwoPoints = true;
            this.capturingState = false;
 ...
 */
var wheel = __webpack_require__(35)
var animate = __webpack_require__(36)
var eventify = __webpack_require__(38);
var kinetic = __webpack_require__(39)
var preventTextSelection = __webpack_require__(40)()
var Transform = __webpack_require__(41);
var makeSvgController = __webpack_require__(42)
var makeDomController = __webpack_require__(43)
...
var BezierEasing = __webpack_require__(37)
        ...
        if (this.tags) {
            window.requestAnimationFrame(() => {
                if (this.tags.primary !== undefined) {
                    ...
                    const showTextLabel = (this.textBox.width + 3 <= this.width)
                        && (this.textBox.height <= this.height);
                    if (showTextLabel) {
                        this.primaryTagTextBG.attr({
                            height: this.textBox.height + 2,
                            width: this.textBox.width + 3,
                            x: this.x + 1,
                            y: this.y + 1,
                        });
                        ...
                        this.primaryTagTextBG.attr({
                            height: Math.min(3, this.height),
                            width: Math.min(3, this.width),
                            x: this.x,
                            y: this.y,
                        });
                        this.primaryTagText.attr({
...
TagsElement.DEFAULT_PRIMARY_TAG_RADIUS = 1;
TagsElement.DEFAULT_SECONDARY_TAG_SIZE = 2;
TagsElement.DEFAULT_SECONDARY_TAG_DY = 2;
exports.TagsElement = TagsElement;
...
class AnchorsElement extends AnchorsComponent_1.AnchorsComponent {
    ...
    onGhostPointerMove(e) {
        if (e.ctrlKey) {
            let p = new Point2D_1.Point2D(e.offsetX, e.offsetY);
            ...
            let swapToDelete = dist < AnchorsElement.ANCHOR_POINT_LINE_SWITCH_THRESHOLD;
    ...
    onGhostPointerUp(e) {
        ...
        if (this.deleteOnPointerUp) {
            ...
            let point = new Point2D_1.Point2D(e.offsetX, e.offsetY);
            let points = rd.points;
            let index = 0;
...
const DragElement_1 = __webpack_require__(54);
const TagsElement_1 = __webpack_require__(55);
class PolygonRegion3D extends Region_1.Region {
    constructor(paper, paperRect = null, regionData, id, tagsDescriptor, callbacks, tagsUpdateOptions) {
        super(paper, paperRect, regionData, callbacks, id, tagsDescriptor, tagsUpdateOptions);
        if (paperRect !== null) {
            this.paperRects = {
...
exports.PolygonRegion3D = PolygonRegion3D;
...
class AnchorsElement extends AnchorsComponent_1.AnchorsComponent {
    ...
    onGhostPointerMove(e) {
        if (e.ctrlKey) {
            let p = new Point2D_1.Point2D(e.offsetX / g.factor, e.offsetY / g.factor);
            let dist = Number.MAX_VALUE;
            let nearestPoint = null;
            let index = -1;
            this.regionData.points.forEach((point, i) => {
...
const Rect_1 = __webpack_require__(1);
const Region_1 = __webpack_require__(8);
const AnchorsElement_1 = __webpack_require__(57);
const DragElement_1 = __webpack_require__(58);
const TagsElement_1 = __webpack_require__(59);
...
class DragElement extends DragComponent_1.DragComponent {
    buildDragLine() {
        ...
        tmppoints.forEach((p) => {
            ...
            tmpNode.addClass("dragRectStyle");
...
class MenuElement extends RegionComponent_1.RegionComponent {
    ...
    addAction(action, icon, actor) {
        ...
        const itemBack = this.menuGroup.rect(1.5, 1.5, this.menuItemSize, this.menuItemSize, 2, 2);
        itemBack.addClass("menuItemBack");
        const itemIcon = this.menuGroup.path(MenuElement.PathCollection.delete.path);
        itemIcon.transform(`scale(0.08) translate(16 16)`);
        itemIcon.addClass("menuIcon");
        itemIcon.addClass("menuIcon-" + icon);
        const itemRect = this.menuGroup.rect(1.5, 1.5, this.menuItemSize, this.menuItemSize, 2, 2);
    ...
    buildOn(paper) {
        ...
        this.rearrangeMenuPosition();
        this.menuRect = this.menuGroup.rect(0, 0, this.mw, this.mh, 1, 1);
...
window.eve = __webpack_require__(63)
